...
public class Attack {
    protected static MapLocation attack(RobotController rc, MapLocation me, RobotType robotType, boolean attackAll, StringBuilder indicatorString) throws GameActionException {
