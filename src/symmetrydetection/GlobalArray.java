...
public strictfp class GlobalArray {
    ...
    public static boolean storeSymmetry(RobotController rc, int symmetry) throws GameActionException {
        if (rc.canWriteSharedArray(0, 0)) {
            ...
            rc.writeSharedArray(0, rc.readSharedArray(0) | (bit0 << 14) | (bit1 << 15));
            return true;
        }
        return false;
    }
